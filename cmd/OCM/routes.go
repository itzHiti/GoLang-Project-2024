...
func (app *application) routes() http.Handler {
	...
	r.HandleFunc("/students/{id}", app.updateStudentHandler).Methods("PUT")
	r.HandleFunc("/students/{id}", app.deleteStudentHandler).Methods("DELETE")
